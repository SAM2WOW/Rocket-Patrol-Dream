class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        // add tutorials
        this.add.text(game.config.width / 2, game.config.height / 2 - 150, "hope you have a ...", {fontFamily: 'PixelFont', fontSize: 50}).setOrigin(0.5, 0.5).setStroke('#000000', 5).setShadow(2, 2, "#333333", 2, false, true);;
        this.add.text(game.config.width / 2, game.config.height / 2 + 300, "[←] [→] Move | [F] Fire | [F11] Toggle Fullscreen", {fontFamily: 'PixelFont', fontSize: 30}).setOrigin(0.5, 0.5).setStroke('#000000', 5).setShadow(2, 2, "#333333", 2, false, true);;
